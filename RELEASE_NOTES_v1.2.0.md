...
Los resúmenes excluyen rutas, parámetros, cookies, cabeceras y claves. Los informes completos sí contienen URL y evidencias: revisar antes de compartir.

Validación: pruebas originales, regresiones e integración del popup con API de Chrome simulada. Pendiente prueba manual en Chrome y revisión de ficha/permisos respecto a la versión publicada en tienda.
